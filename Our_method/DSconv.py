...
if __name__ == "__main__":
    net = DSConv_pro(in_channels=128, out_channels=128).cuda()
    input_tensor = torch.randn(4, 128, 256, 256).cuda()
    output = net(input_tensor)
    print(output.size())
    summary(net, (128, 256, 256), batch_size=-1, device="cuda")